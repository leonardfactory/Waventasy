...
open class NodeView : BoardItemView {
    var nameLabel:NSTextField!
    var backgroundImageView:NSImageView!
    var trackingArea:NSTrackingArea!
    
    var inputView:NSStackView!
    var outputView:NSStackView!
    
    var inputSubviews:Dictionary<Input, SoundNodeSlotInputView> = [:]
    var outputSubviews:Dictionary<Output, SoundNodeSlotOutputView> = [:]
